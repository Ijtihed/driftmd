  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="hidden md:block px-6 py-28">
          <div className="max-w-4xl mx-auto">
            <p className="font-[JetBrains_Mono] text-xs text-neutral-600 uppercase tracking-[0.3em] mb-6 text-center">
              How it works
            </p>
            <h2 className="font-[Manrope] text-3xl sm:text-4xl font-light text-white tracking-tight text-center mb-20">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                ...
                <p className="font-[JetBrains_Mono] text-xs text-neutral-500 leading-relaxed max-w-[220px] mx-auto">
              ...
              <div className="text-center">
                ...
                <p className="font-[JetBrains_Mono] text-xs text-neutral-500 leading-relaxed max-w-[220px] mx-auto">
                  Cross-references every claim against actual files, CLI flags, env vars, badges, and function signatures.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="font-[JetBrains_Mono] text-xs text-neutral-500 leading-relaxed max-w-[220px] mx-auto">
                  File doesn&apos;t exist. Flag removed. Env var unused. Badge outdated. You fix it before users notice.
                </p>
              </div>
            </div>
        ...
        <div className="hidden md:block w-16 h-px bg-neutral-800 mx-auto" />

        {/* Get started */}
        <section className="px-4 sm:px-6 py-12 md:py-28">
